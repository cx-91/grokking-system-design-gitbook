...
### 1. What is Facebook Messenger?[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#1.-What-is-Facebook-Messenger?) <a href="#1.-what-is-facebook-messenger" id="1.-what-is-facebook-messenger"></a>
...
### 2. Requirements and Goals of the System[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#2.-Requirements-and-Goals-of-the-System) <a href="#2.-requirements-and-goals-of-the-system" id="2.-requirements-and-goals-of-the-system"></a>
...
### 3. Capacity Estimation and Constraints[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#3.-Capacity-Estimation-and-Constraints) <a href="#3.-capacity-estimation-and-constraints" id="3.-capacity-estimation-and-constraints"></a>
...
### 4. High Level Design[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#4.-High-Level-Design) <a href="#4.-high-level-design" id="4.-high-level-design"></a>
...
![](.gitbook/assets/5171638929702\_.pic\_hd.jpg)
...
![](.gitbook/assets/5181638929763\_.pic.jpg)

![](.gitbook/assets/5191638929776\_.pic.jpg)



![](.gitbook/assets/5201638929850\_.pic.jpg)

![](<.gitbook/assets/5211638929867\_.pic (1).jpg>)

![](.gitbook/assets/5221638929921\_.pic.jpg)

![](.gitbook/assets/5231638929947\_.pic.jpg)

![](.gitbook/assets/5241638929969\_.pic.jpg)

![](.gitbook/assets/5251638929994\_.pic.jpg)

### 5. Detailed Component Design[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#5.-Detailed-Component-Design) <a href="#5.-detailed-component-design" id="5.-detailed-component-design"></a>
...
#### a. Messages Handling[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#a.-Messages-Handling) <a href="#a.-messages-handling" id="a.-messages-handling"></a>
...
#### b. Storing and retrieving the messages from the database[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#b.-Storing-and-retrieving-the-messages-from-the-database) <a href="#b.-storing-and-retrieving-the-messages-from-the-database" id="b.-storing-and-retrieving-the-messages-from-the-database"></a>
...
Both of our requirements can be easily met with a wide-column database solution like [HBase](https://en.wikipedia.org/wiki/Apache\_HBase). HBase is a column-oriented key-value NoSQL database that can store multiple values against one key into multiple columns. HBase is modeled after Google’s [BigTable](https://en.wikipedia.org/wiki/Bigtable) and runs on top of Hadoop Distributed File System ([HDFS](https://en.wikipedia.org/wiki/Apache\_Hadoop)). HBase groups data together to store new data in a memory buffer and, once the buffer is full, it dumps the data to the disk. This way of storage not only helps to store a lot of small data quickly but also fetching rows by the key or scanning ranges of rows. HBase is also an efficient database to store variable-sized data, which is also required by our service.
...
#### c. Managing user’s status[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#c.-Managing-user%E2%80%99s-status) <a href="#c.-managing-users-status" id="c.-managing-users-status"></a>
...
![](.gitbook/assets/5261638930074\_.pic\_hd.jpg)
...
### 6. Data partitioning[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#6.-Data-partitioning) <a href="#6.-data-partitioning" id="6.-data-partitioning"></a>
...
### 7. Cache[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#7.-Cache) <a href="#7.-cache" id="7.-cache"></a>
...
### 8. Load balancing[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#8.-Load-balancing) <a href="#8.-load-balancing" id="8.-load-balancing"></a>
...
### 9. Fault tolerance and Replication[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#9.-Fault-tolerance-and-Replication) <a href="#9.-fault-tolerance-and-replication" id="9.-fault-tolerance-and-replication"></a>
...
### 10. Extended Requirements[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#10.-Extended-Requirements) <a href="#10.-extended-requirements" id="10.-extended-requirements"></a>

#### a. Group chat[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#a.-Group-chat) <a href="#a.-group-chat" id="a.-group-chat"></a>
...
#### b. Push notifications[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8R22v0wqJo#b.-Push-notifications) <a href="#b.-push-notifications" id="b.-push-notifications"></a>
