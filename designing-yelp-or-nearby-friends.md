...
### 1. Why Yelp or Proximity Server?[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#1.-Why-Yelp-or-Proximity-Server?) <a href="#1.-why-yelp-or-proximity-server" id="1.-why-yelp-or-proximity-server"></a>
...
### 2. Requirements and Goals of the System[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#2.-Requirements-and-Goals-of-the-System) <a href="#2.-requirements-and-goals-of-the-system" id="2.-requirements-and-goals-of-the-system"></a>
...
### 3. Scale Estimation[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#3.-Scale-Estimation) <a href="#3.-scale-estimation" id="3.-scale-estimation"></a>
...
### 4. Database Schema[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#4.-Database-Schema) <a href="#4.-database-schema" id="4.-database-schema"></a>
...
### 5. System APIs[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#5.-System-APIs) <a href="#5.-system-apis" id="5.-system-apis"></a>
...
### 6. Basic System Design and Algorithm[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#6.-Basic-System-Design-and-Algorithm) <a href="#6.-basic-system-design-and-algorithm" id="6.-basic-system-design-and-algorithm"></a>
...
#### a. SQL solution[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#a.-SQL-solution) <a href="#a.-sql-solution" id="a.-sql-solution"></a>
...
#### b. Grids[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#b.-Grids) <a href="#b.-grids" id="b.-grids"></a>
...
_Select \* from Places where Latitude between X-D and X+D and Longitude between Y-D and Y+D and GridID in (GridID, GridID1, GridID2, ..., GridID8)_
...
#### c. Dynamic size grids[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#c.-Dynamic-size-grids) <a href="#c.-dynamic-size-grids" id="c.-dynamic-size-grids"></a>
...
### 7. Data Partitioning[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#7.-Data-Partitioning) <a href="#7.-data-partitioning" id="7.-data-partitioning"></a>
...
### 8. Replication and Fault Tolerance[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#8.-Replication-and-Fault-Tolerance) <a href="#8.-replication-and-fault-tolerance" id="8.-replication-and-fault-tolerance"></a>
...
### 9. Cache[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#9.-Cache) <a href="#9.-cache" id="9.-cache"></a>
...
### 10. Load Balancing (LB)[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#10.-Load-Balancing-\(LB\)) <a href="#10.-load-balancing-lb" id="10.-load-balancing-lb"></a>
...
### 11. Ranking[#](https://www.educative.io/courses/grokking-the-system-design-interview/B8rpM8E16LQ#11.-Ranking) <a href="#11.-ranking" id="11.-ranking"></a>
