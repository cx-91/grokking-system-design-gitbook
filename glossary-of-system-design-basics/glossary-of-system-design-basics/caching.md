...
### Application server cache[#](https://www.educative.io/courses/grokking-the-system-design-interview/3j6NnJrpp5p#Application-server-cache) <a href="#application-server-cache" id="application-server-cache"></a>
...
### Content Delivery (or Distribution) Network (CDN)[#](https://www.educative.io/courses/grokking-the-system-design-interview/3j6NnJrpp5p#Content-Delivery-\(or-Distribution\)-Network-\(CDN\)) <a href="#content-delivery-or-distribution-network-cdn" id="content-delivery-or-distribution-network-cdn"></a>
...
### Cache Invalidation[#](https://www.educative.io/courses/grokking-the-system-design-interview/3j6NnJrpp5p#Cache-Invalidation) <a href="#cache-invalidation" id="cache-invalidation"></a>
...
### Cache eviction policies[#](https://www.educative.io/courses/grokking-the-system-design-interview/3j6NnJrpp5p#Cache-eviction-policies) <a href="#cache-eviction-policies" id="cache-eviction-policies"></a>
...
\[1] [Cache](https://en.wikipedia.org/wiki/Cache\_\(computing\))\
