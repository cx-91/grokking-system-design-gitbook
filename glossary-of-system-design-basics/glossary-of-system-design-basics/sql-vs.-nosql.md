...
### SQL[#](https://www.educative.io/courses/grokking-the-system-design-interview/YQlK1mDPgpK#SQL) <a href="#sql" id="sql"></a>
...
### NoSQL[#](https://www.educative.io/courses/grokking-the-system-design-interview/YQlK1mDPgpK#NoSQL) <a href="#nosql" id="nosql"></a>
...
### High level differences between SQL and NoSQL[#](https://www.educative.io/courses/grokking-the-system-design-interview/YQlK1mDPgpK#High-level-differences-between-SQL-and-NoSQL) <a href="#high-level-differences-between-sql-and-nosql" id="high-level-differences-between-sql-and-nosql"></a>
...
### SQL VS. NoSQL - Which one to use?[#](https://www.educative.io/courses/grokking-the-system-design-interview/YQlK1mDPgpK#SQL-VS.-NoSQL---Which-one-to-use?) <a href="#sql-vs.-nosql-which-one-to-use" id="sql-vs.-nosql-which-one-to-use"></a>
...
### Reasons to use SQL database[#](https://www.educative.io/courses/grokking-the-system-design-interview/YQlK1mDPgpK#Reasons-to-use-SQL-database) <a href="#reasons-to-use-sql-database" id="reasons-to-use-sql-database"></a>
...
### Reasons to use NoSQL database[#](https://www.educative.io/courses/grokking-the-system-design-interview/YQlK1mDPgpK#Reasons-to-use-NoSQL-database) <a href="#reasons-to-use-nosql-database" id="reasons-to-use-nosql-database"></a>
